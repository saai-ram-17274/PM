      ...
      <div class="inv-graph-container" id="graphContainer">
        <div class="inv-graph-canvas" id="graphCanvas">
          ...
          <svg viewBox="0 0 1200 700" xmlns="http://www.w3.org/2000/svg" id="graphSvg" overflow="visible">
            ...
            <line x1="580" y1="85" x2="280" y2="230" class="graph-edge-mal" marker-end="url(#arrow-mal)" data-source="alert-impossible-travel" data-target="user-m-henderson" data-label="TRIGGERED_BY"/>
            <line x1="600" y1="85" x2="890" y2="175" class="graph-edge-mal" marker-end="url(#arrow-mal)" data-source="alert-impossible-travel" data-target="svc-azure-ad" data-label="DETECTED_ON"/>
            ...
            <line x1="910" y1="210" x2="940" y2="550" class="graph-edge-mal" marker-end="url(#arrow-mal)" data-source="svc-azure-ad" data-target="svc-oauth" data-label="ISSUED"/>
            ...
            <g class="edge-info-btn" data-label="TRIGGERED_BY" data-source="alert-impossible-travel" data-target="user-m-henderson" onclick="showEdgeRelation(event,this)"><circle cx="430" cy="155" r="10" fill="#fff" stroke="#ef4444" stroke-width="1.5"/><text x="430" y="159" text-anchor="middle" font-size="11" dominant-baseline="central">⚡</text></g>
            <g class="edge-info-btn" data-label="DETECTED_ON" data-source="alert-impossible-travel" data-target="svc-azure-ad" onclick="showEdgeRelation(event,this)"><circle cx="740" cy="125" r="10" fill="#fff" stroke="#ef4444" stroke-width="1.5"/><text x="740" y="129" text-anchor="middle" font-size="11" dominant-baseline="central">🔍</text></g>
            ...
            <g class="edge-info-btn" data-label="ISSUED" data-source="svc-azure-ad" data-target="svc-oauth" onclick="showEdgeRelation(event,this)"><circle cx="925" cy="377" r="10" fill="#fff" stroke="#ef4444" stroke-width="1.5"/><text x="925" y="381" text-anchor="middle" font-size="11" dominant-baseline="central">📜</text></g>
